...
{
    public function test_can_format_to_currency()
    {
    ...
    public function test_can_format_to_currency_in_lowercaps_currency_code()
    {
        $this->assertEquals(123.46, format_to_currency('usd', 123.456789123456));
        $this->assertEquals(123.45678912, format_to_currency('btc', 123.456789123456));
    }

    public function test_format_to_currency_throws_exception_when_passed_with_invalid_currency_code_argument()
    {
